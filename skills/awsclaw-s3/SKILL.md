---
name: awsclaw-s3
description: Manage Amazon S3 buckets and objects using awsclaw. Create, configure, and delete buckets, upload/download objects, inspect bucket configuration (encryption, versioning, lifecycle, replication, logging, CORS, website), query object content with S3 Select, and open the S3 Explorer view.
---
...
- **S3 File Operations**: For bulk upload/download of files and folders, use the `S3FileOperationsTool` (see awsclaw-s3-fileops skill)
