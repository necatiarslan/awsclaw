---
name: awsclaw-cloudformation
description: Manage and inspect AWS CloudFormation stacks, resources, changesets, types, drift detection, and stack sets using the awsclaw VS Code extension CloudFormationTool.
---
