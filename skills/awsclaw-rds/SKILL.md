---
name: awsclaw-rds
description: Manage and inspect Amazon RDS instances, clusters, snapshots, parameter groups, logs, proxies, events, engine versions, subnet groups, security groups, certificates, recommendations, and more using awsclaw.
---
...
- **RDS → RDS Data API**: For Aurora Serverless clusters with Data API enabled, use `RDSDataTool` to execute SQL directly (see awsclaw-rdsdata skill)
